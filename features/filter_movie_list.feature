...
Scenario: restrict to movies with "PG" or "R" ratings
  ...
  Then I should see the following movies: Aladdin, The Terminator, When Harry Met Sally, Amelie, 2001: A Space Odyssey, The Incredibles, Raiders of the Lost Ark, Chicken Run
